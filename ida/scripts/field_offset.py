#!/usr/bin/env python3
"""
Compute IL2CPP object/Fields offsets from noisy IDA pseudo-C expressions.

This script only performs offset arithmetic. Resolve the final field name with
IDA MCP analyze_struct_detailed(..._Fields) or the dumped C# [FieldOffset] data.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Compute IL2CPP object and Fields offsets from IDA pseudo-C noise.",
    )
    parser.add_argument(
        "--object-size",
        type=parse_int,
